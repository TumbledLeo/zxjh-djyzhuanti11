$(function(){
  $('.play').hover(function(){
    $(this).addClass('active').parent().find('.menu').stop(true).fadeIn(100).animate({marginTop:"-1px",opacity:"1",zIndex:"99"});
